...
public class TaumAndBday {
    ...
    public static void main(String[] args) {
        ...
        while( tc>0){
            tc--;
            long noBlack = in.nextInt();
            long noWhite = in.nextInt();
            long costBlack = in.nextInt();
            long costWhite = in.nextInt();
            long costPaint = in.nextInt();
            
            long totalbuyBlack= costBlack < (costWhite+costPaint) ? noBlack*costBlack : noBlack*(costWhite+costPaint);
            long totalbuyWhite = costWhite < (costBlack+costPaint) ? noWhite*costWhite : noWhite*(costBlack+costPaint);
            //System.out.println("Black cost["+totalbuyBlack+"]totalbuyWhite["+totalbuyWhite+"]");
               
            long totalbuy = totalbuyBlack+totalbuyWhite;
